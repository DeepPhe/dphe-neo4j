...
//         }
    ...
    private void addNoteInfo(final GraphDatabaseService graphDb,
        ...
        try (Transaction tx = graphDb.beginTx()) {
            ...
            //JDL 2021-08-05: Sean added this to help with a problem I was having, but I'm not longer having that problem
            //                and "clearNode()" is causing a StackOverflow when called on my machine so I am commenting it
            //                out.
            ...
            //} else {
            Node node = graphDb.createNode(TEXT_DOCUMENT_LABEL);
